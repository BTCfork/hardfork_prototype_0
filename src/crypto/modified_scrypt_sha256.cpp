/* HFP0 POW begin: added file from satoshisbitcoin, minor cleanups */

#include <assert.h>
#include <stdint.h>
#include <string.h>
#include <limits>       // HFP0 CLN added
...
{
	volatile uint8_t * _buf = (uint8_t *)buf;
	size_t i;
    ...
    size_t saltlen, uint64_t c, uint8_t * buf, size_t dkLen)
{
	...
	/* Sanity-check. */
    // HFP0 CLN begin: use std::numeric_limits instead of UINT32_MAX
    assert(dkLen <= 32 * (size_t)(std::numeric_limits<uint32_t>::max()));
    // HFP0 CLN end
